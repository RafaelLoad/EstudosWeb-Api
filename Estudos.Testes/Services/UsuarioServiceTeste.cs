...
namespace Estudos.Aplication.Testes.Services
{
    public class UsuarioServiceTeste
    {
        ...
        {
            usuarioService = new UsuarioService(new Mock<IUsuarioRepository>().Object, new Mock<DbContext>().Object);  
        }
        ...
        public async void Buscar_GetUser()
        {
           ...
           var loginViewModel = new LoginViewModel { Usuario = "Rafa", Senha = "Rafa" };
